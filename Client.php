...
class Client {
     ...
     */
    public function __construct( $hash, $name, $file, $api_url = '') {
        $this->hash = $hash;
        $this->name = $name;
        $this->file = $file;
    ...
    public function send_request( $params, $route, $blocking = false ) {
        ...
        $headers = [
            'user-agent' => 'Licenser/' . md5( esc_url( home_url() ) ) . ';',
