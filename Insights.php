...
class Insights
{
    ...
    public function __construct($client, $name = null, $file = null)
    {
        ...
        if (is_object($client) && is_a($client, 'Licenser\Client')) {
            $this->client = $client;
        }
    }
    ...
    /**
     * Send tracking data to Licenser server
     *
     * @param bool $override
     *
     * @return void
    ...
    public function admin_notice()
    {
        ...
        $policy_url = 'https://licenser.com/privacy-policy/';
        ...
        $notice .= 'We are using Licenser to collect your data. <a href="' . $policy_url . '" target="_blank">Learn more</a> about how Licenser collects and handle your data.</p>';
    ...
    public function uninstall_reason_submission()
    {
        ...
        if (!wp_verify_nonce(sanitize_key(wp_unslash($_POST['nonce'])), 'licenser-security-nonce')) {
    ...
    public function deactivate_scripts()
    {
        ...
        $custom_reasons = apply_filters('licenser_custom_deactivation_reasons', [], $this->client);
?>
            ...
            <div class="wd-dr-modal-wrap">
                ...
                <div class="wd-dr-modal-body">
                    ...
                    <p class="wd-dr-modal-reasons-bottom">
                        <?php
                        echo sprintf(
                            $this->client->__trans('We share your data with <a href="%1$s" target="_blank">Licenser</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Licenser handles your data.'),
                            esc_url('https://licenser.com/'),
                            esc_url('https://licenser.com/privacy-policy')
                        );
                        ?>
                    </p>
                </div>
                ...
                $(function() {
                    ...
                    modal.on('click', 'button.wd-dr-submit-modal', function(e) {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                nonce: '<?php echo wp_create_nonce('licenser-security-nonce'); ?>',
    ...
    {
        // Make sure this is licenser theme
    ...
    /**
     * Send request to licenser if user skip to send tracking data
     */
